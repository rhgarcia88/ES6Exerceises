...
function filterStreamers(array,text){
    const searchResults = array.filter(element=>element.name.toLowerCase().includes(text));
    console.log(searchResults);
}

input.addEventListener('input',()=>{filterStreamers(streamers,input.value)});